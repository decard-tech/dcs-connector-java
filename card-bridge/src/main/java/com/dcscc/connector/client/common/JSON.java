...
public final class JSON {
    ...
    private static final OffsetDateTimeTypeAdapter offsetDateTimeTypeAdapter =
    ...
    public static final int TIMEZONE_LENGTH = 5;
            ...
            switch (in.peek()) {
                ...
                default:
                    ...
                    if (date.endsWith("+0000")) {
                        date = date.substring(0, date.length() - TIMEZONE_LENGTH) + "Z";
                    }
