...
public class FCTransferToSpendingRequest {
    ...
    public FCTransferToSpendingRequest() {}
    public String getExternalTranId() { return externalTranId; }
    public FCTransferToSpendingRequest setExternalTranId(String v) { this.externalTranId = v; return this; }
    public String getExternalUserId() { return externalUserId; }
    public FCTransferToSpendingRequest setExternalUserId(String v) { this.externalUserId = v; return this; }
    public BigDecimal getAmount() { return amount; }
    public FCTransferToSpendingRequest setAmount(BigDecimal v) { this.amount = v; return this; }
    public String getCurrency() { return currency; }
    public FCTransferToSpendingRequest setCurrency(String v) { this.currency = v; return this; }
    public String getRemark() { return remark; }
    public FCTransferToSpendingRequest setRemark(String v) { this.remark = v; return this; }
    ...
    @Override public String toString() { return "FCTransferToSpendingRequest{externalTranId='" + externalTranId + "', amount=" + amount + "}"; }
}
